...
from Agents.MAMO.multiplexers import CriticMultiplexer
from acme.tf import utils as tf2_utils
import numpy as np
import sonnet as snt
from Agents.MAMO.dueling import DuellingMLP
...
# network 1
# vehicle_policy_layer_sizes: Sequence[int] = (64, 32),
# vehicle_critic_layer_sizes: Sequence[int] = (128, 64),
# edge_policy_layer_sizes: Sequence[int] = (64, 32),
# edge_critic_layer_sizes: Sequence[int] = (128, 64),
# network 2
# vehicle_policy_layer_sizes: Sequence[int] = (128, 64),
# vehicle_critic_layer_sizes: Sequence[int] = (256, 128),
# edge_policy_layer_sizes: Sequence[int] = (128, 64),
# edge_critic_layer_sizes: Sequence[int] = (256, 128),
# # defaults
...
# # network 4
# vehicle_policy_layer_sizes: Sequence[int] = (512, 256),
# vehicle_critic_layer_sizes: Sequence[int] = (1024, 512),
# edge_policy_layer_sizes: Sequence[int] = (512, 256),
# edge_critic_layer_sizes: Sequence[int] = (1024, 512),
# # network 5
# vehicle_policy_layer_sizes: Sequence[int] = (1024, 512),
# vehicle_critic_layer_sizes: Sequence[int] = (2048, 1024),
# edge_policy_layer_sizes: Sequence[int] = (1024, 512),
# edge_critic_layer_sizes: Sequence[int] = (2048, 1024),
